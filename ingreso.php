<?php 
        ...
        elseif ($result->num_rows)
        {
            ...
            if (password_verify($pw_temp, $row[3])) 
            {
               ...
               htmlspecialchars("$row[0] $row[1]:
                ...
                die ("<p><center><body style=background-image:url('imagen/fondoinvi.jpg width=100% height=100vh ')><a href='Inicio.php'>
              <br><br><br><h1>Click para Ingresar</a></p>");
            }

            else {
                echo "<h1>Usuario/password incorrecto <p><center><body style=background-image:url('imagen/paisaje2.jpeg width=100% height=100vh ')><a href='registros.php'>
           <h1> Registrarse</a></p>";
            }
        }
        else {
          echo "<h1>Usuario/password incorrecto <p><body style=background-image:url('imagen/fondoinvi.jpg width=100% height=100vh')><a href='registros.php'>
    ...
    else
    {
      ...
      Password <input type="password" name="password" placeholder="password">
               ...
               <img src="imagen/descarga (1).jfif" width="450" height="380" "aling="right">
      </form>
      <body>
      _END;
    }
