<?php 
   $conexion = new mysqli('localhost', 'root','', 'diario',3310);
    ...
    else
    {
        ...
        <center>
        <h1>  Regístrate</h1> <body style=background-image:url('imagen/fondoinvi.jpg width=100% height=100vh ')>
        ...
        Password  <input type="text" name="password"placeholder="password">
                  ...
                  <img src="imagen/grupoooo.jpeg" width="350px" height="250" "aling="right">
        </form> </body>
        _END;
    }
